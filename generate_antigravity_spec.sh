...
# Fetch from AUR
PKGBUILD=$(curl -s "https://aur.archlinux.org/cgit/aur.git/plain/PKGBUILD?h=antigravity")
...
echo "Generated antigravity.spec for version $PKGVER"
